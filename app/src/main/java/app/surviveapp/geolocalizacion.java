...
public class geolocalizacion extends FragmentActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(),"Selecciona el punto de partida", Toast.LENGTH_LONG).show();
    }
            ...
            if (checkSelfPermission(Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_DENIED) {
                ...
                mMap.setOnMapLongClickListener(new GoogleMap.OnMapLongClickListener() {
                    ...
                    public void onMapLongClick(LatLng latLng) {
                        ...
                        Toast.makeText(getApplicationContext(),"Se ha seleccionado el punto de partida", Toast.LENGTH_LONG).show();
                        if(mOrigin != null && mDestination != null)
                            drawRoute();
                    }
                });
...
//
//            }else
//                Toast.makeText(getApplicationContext(),"No se encuentra la ruta", Toast.LENGTH_LONG).show();
//        }
    }
